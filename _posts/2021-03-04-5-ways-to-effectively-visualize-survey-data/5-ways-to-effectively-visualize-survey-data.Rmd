...
Students can answer the items by selecting one the following response options or skip them without choosing a response option (missing responses are labeled as 999 in the data):
