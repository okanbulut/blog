...
# convert reading performance to binary classification based on average. 1 represents higher and 0 represents lower performance.
mean(pisa$reading)
pisa$reading= factor(ifelse(pisa$reading >= 428, 1, 0))
table(pisa$reading)
```
